...
def precompute_freqs_cis(dim: int, end: int, theta: float = 10000.0, theta_rescale_factor=1.0):
    ...
    # Return on CPU; nn.Module.register_buffer will move to the right device.
...
class AttnProcessor:
    def __call__(self, attn: Attention, x, mask=None, rope=None):
...
class TimestepEmbedding(nn.Module):
    ...
    def forward(self, timestep):
        ...
        time = self.time_mlp(time_hidden.float())
        return time
